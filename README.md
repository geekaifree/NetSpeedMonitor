...
<p align="center">
  <img src="assets/icon.svg" width="128" height="128" alt="NetSpeedMonitor">
</p>

<p align="center">
  <strong>NetSpeedMonitor</strong>
</p>
...
NetSpeedMonitor 是一款跨平台NetSpeedMonitor工具，基于 Flutter 框架开发，支持 Android、macOS、iOS 三平台。
